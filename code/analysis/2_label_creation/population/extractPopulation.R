...
# Scope: Do you want the USA or a dense sample for Figure $? 
scope = "dense" #"USA"
...
if(scope == "USA") {
  ...
  fileEnding = paste0("DenseSample_population_16_640_regular_37251")
  gridFile = file.path(data_dir,"int/grids", paste0(fileEnding,".npz"))
}
...
dt$population[is.na(dt$population)] = -999
...
if (scope == "USA") {
  ...
  S = length(sampLat)
  fn = file.path(data_dir,"int/applications/population", paste0("outcomes_sampled_population_dense_16_640_regular_", S, ".csv"))
}
